...
export default function HomePage() {
  ...
  return (
    <div className="relative flex h-auto min-h-screen w-full flex-col bg-luxury-pattern-subtle overflow-x-hidden pt-[60px]">
      ...
      {/* ─────────────────────────────────────────────────────────────────── */}
      {/* 1.5. HOME GALLERY MARQUEE — Clickable to Gallery Page               */}
      {/* ─────────────────────────────────────────────────────────────────── */}
      <HomeGalleryMarquee />
      ...
      {/* ─────────────────────────────────────────────────────────────────── */}
      {/* 4.5. PRIVATE CLIENT TESTIMONIALS (CLEAN LUXURY UI)                  */}
      {/* ─────────────────────────────────────────────────────────────────── */}
      <section className="w-full bg-[#FAF7F2] border-t border-[#E8E4DC] py-16 md:py-24">
        <div className="max-w-[1240px] mx-auto px-6 md:px-12 flex flex-col gap-12">
          ...
          <div className="flex flex-col items-center text-center gap-2.5 reveal-item">
            ...
            >
              Words from Discerning Homeowners
            </h2>
            <div className="flex items-center gap-2">
            ...
            <p className="text-[#72716d] text-sm md:text-base max-w-2xl font-light leading-relaxed">
              Reflections from residents and investors who entrusted their family sanctuary and enduring legacy to Luxehomes.
            </p>
          </div>

          {/* Testimonial Cards Grid (Clean Luxury UI) */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-7">

            {/* Testimonial 1 */}
            <div className="reveal-item reveal-delay-1 bg-white rounded-3xl p-7 md:p-8 border border-[#E8E4DC] hover:border-[#B08D57] shadow-sm hover:shadow-xl hover:-translate-y-1.5 transition-all duration-300 relative flex flex-col justify-between group">
              <div className="flex flex-col gap-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-3xl text-[#B08D57]/30 font-serif leading-none select-none">“</span>
                </div>

                {/* Quote Text */}
                <p
                  className="text-sm md:text-[15px] text-[#1c1b1b] font-normal leading-relaxed italic"
                  style={{ fontFamily: "'Cormorant Garant', serif" }}
                >
                  &ldquo;The acoustic silence inside our 4 BHK Sky Mansion is astonishing given our proximity to the Financial District. The structural integrity, natural light, and strict adherence to Vastu were decisive factors for our family.&rdquo;
                </p>
              </div>

              {/* Author Details */}
              <div className="pt-6 mt-6 border-t border-[#E8E4DC] flex flex-col gap-1">
                <h4
                  className="text-base font-normal text-[#1c1b1b]"
                  style={{ fontFamily: "'Playfair Display', serif" }}
                >
                  Dr. Arvind &amp; Radhika Swaminathan
                </h4>
                <p className="text-xs text-[#72716d]">Senior Cardiologist, Continental Hospitals</p>
                <div className="mt-2 inline-flex items-center gap-1.5 text-[9.5px] uppercase tracking-wider font-semibold text-[#B08D57] px-2.5 py-0.5 rounded-full bg-[#FAF7F2] border border-[#E8E4DC] w-max">
                  <span className="size-1 rounded-full bg-emerald-500" />
                  <span>Resident · Botanika Greens, Tower A</span>
                </div>
              </div>
            </div>

            {/* Testimonial 2 */}
            <div className="reveal-item reveal-delay-2 bg-white rounded-3xl p-7 md:p-8 border border-[#E8E4DC] hover:border-[#B08D57] shadow-sm hover:shadow-xl hover:-translate-y-1.5 transition-all duration-300 relative flex flex-col justify-between group">
              <div className="flex flex-col gap-4">
                {/* 5-Star Rating & Quote Mark */}
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-1 text-[#B08D57]">
                ...
                <p
                  ...
                  style={{ fontFamily: "'Cormorant Garant', serif" }}
                >
                  &ldquo;In luxury real estate, promises often exceed execution. Luxehomes is the rare exception. Every sanction, possession milestone, and finishing detail matched the prospectus exactly. The Kokapet advisory team is world-class.&rdquo;
                </p>
              </div>
              ...
              <div className="pt-6 mt-6 border-t border-[#E8E4DC] flex flex-col gap-1">
                ...
                <p className="text-xs text-[#72716d]">Managing Director, Global FinTech Group</p>
                <div className="mt-2 inline-flex items-center gap-1.5 text-[9.5px] uppercase tracking-wider font-semibold text-[#B08D57] px-2.5 py-0.5 rounded-full bg-[#FAF7F2] border border-[#E8E4DC] w-max">
                  <span className="size-1 rounded-full bg-emerald-500" />
                  <span>Resident · One Neopolis, Tower B</span>
                </div>
              </div>
            </div>

            {/* Testimonial 3 */}
            <div className="reveal-item reveal-delay-3 bg-white rounded-3xl p-7 md:p-8 border border-[#E8E4DC] hover:border-[#B08D57] shadow-sm hover:shadow-xl hover:-translate-y-1.5 transition-all duration-300 relative flex flex-col justify-between group">
              <div className="flex flex-col gap-4">
                {/* 5-Star Rating & Quote Mark */}
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-1 text-[#B08D57]">
                ...
                <p
                  ...
                  style={{ fontFamily: "'Cormorant Garant', serif" }}
                >
                  &ldquo;From the double-height entrance lobbies to the high-speed transit directly onto the ORR Exit 1, living here feels like an international private sanctuary. The acoustic insulation and craftsmanship are unparalleled.&rdquo;
                </p>
              </div>
              ...
              <div className="pt-6 mt-6 border-t border-[#E8E4DC] flex flex-col gap-1">
                <h4
                  ...
                  style={{ fontFamily: "'Playfair Display', serif" }}
                >
                  Meera &amp; Rajesh Nambiar
                </h4>
                <p className="text-xs text-[#72716d]">Venture Partner &amp; Tech Entrepreneur</p>
                <div className="mt-2 inline-flex items-center gap-1.5 text-[9.5px] uppercase tracking-wider font-semibold text-[#B08D57] px-2.5 py-0.5 rounded-full bg-[#FAF7F2] border border-[#E8E4DC] w-max">
                  <span className="size-1 rounded-full bg-emerald-500" />
                  <span>Resident · Cyber Vista, Kokapet</span>
                </div>
              </div>
            </div>
